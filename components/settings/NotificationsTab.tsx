    ...
    <div className="max-w-2xl space-y-6">
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          <Mail className="size-4 text-[#007bb8]" />
          <h3 className="text-sm font-semibold uppercase tracking-wide text-[#1a2d3d]">Email</h3>
        </div>
        <div className="rounded-lg border border-[#dfe8f0] bg-white p-4 space-y-3">
          <div>
            <Label htmlFor="reply_to_email" className="text-sm font-semibold text-[#1a2d3d]">
              Reply-to address
            </Label>
            <p className="mt-0.5 text-sm text-muted-foreground">
              Clients who reply to invoices, quotes, and reminders will reach this address.
            </p>
          </div>
          <Input
            id="reply_to_email"
      ...
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          <h3 className="text-sm font-semibold uppercase tracking-wide text-[#1a2d3d]">Alerts</h3>
        </div>
        {[
          {
